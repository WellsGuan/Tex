...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for PDE by Evans}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on the Lecture Notes by Cole Graham} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
