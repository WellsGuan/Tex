...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for Analysis and PDEs}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on Math 719 (Cole), Math 720 (M.~Ifrim), Folland, etc.} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
...
\include{tex/Checklist}
\include{tex/Introduction}
\include{tex/Sobolev}
\include{tex/Elliptic}
