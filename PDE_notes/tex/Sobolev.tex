...
\begin{proposition}
    Let $X,Y$ be Banach spaces, and let $P:X\to Y$ be bounded linear operator. Suppose $||v||_{Y^{*}} \leq C||P^*v||_{X^*}$. Then
    \begin{enumerate}
...
\begin{proposition}
    All sobolev spaces $W^{k,p}_0(U)$ with $1 < p < \infty$ are reflexive.
\end{proposition}
