...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for Riemannian Manifolds}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on the MATH 765 by A.Waldron 2026, GTM 275 by Loring W.Tu, GTM 94 by F.Warner} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
...
\include{Riemannian_Geometry/tex/Preliminary}
