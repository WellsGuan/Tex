...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for Renormalization Flow}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on the paper by A.Dunlap and Cole} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
...
\include{tex/Setup}
\include{tex/fbsde}
\include{tex/parabolicpde}
\include{tex/spde}
%\include{tex/openproblem}
%\include{tex/openproblem_appended_ux_decay}
\include{tex/OP1_reorganized_OP_O_style}
\include{tex/boundedsigma}
