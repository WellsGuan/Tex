...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for Smooth Manifolds}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on the John Lee} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
...
\include{tex/smooth-manifolds.tex}
\include{tex/smooth_maps.tex}
\include{tex/tangent_vector.tex}
\include{tex/subimmemb.tex}
\include{tex/Lie_groups.tex}
\include{tex/vector_fields.tex}
\include{tex/integral_curves_and_flows.tex}
\include{tex/vector_bundles.tex}
\include{tex/differential_forms.tex}
