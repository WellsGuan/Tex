...
1. \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\linewidth]{STATS_Minor/701/cet_temp.png}
    \caption{CET}
\end{figure}\par
Data points do not appear to be stationary. The average temperatures by month show a seasonal trend, with much lower temperatures in January than in July. They also differ across multi-decade periods, suggesting a changing mean level, which is contravertial to the invariant mean value of a stationary process.
\par 
\vspace{0.5em}
