...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{Notes for Stochastic Calculus}
		\HRule{2.0pt} \\ [0.6cm] \LARGE{Based on the Paolo Baldi} \vspace*{10\baselineskip}}
		}
\date{}
\author{\textbf{Author} \\ 
		Wells Guan \\
...
\include{tex/Probability.tex}
\include{tex/Process.tex}
